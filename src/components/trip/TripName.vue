<template>
  <div>
    ...
    >
      <div>
        You are about to archive this route.<br />You will not be able to make any changes until you restore it.<br />Do
    ...
    <Popper :interactive="false" :hover="true">
      <button v-if="!route.active" @click="setTripActive(route._id)" class="bg-green fg-yellow clickable">
        Set Active
      </button>
      <template #content>
    ...
    <Popper :interactive="false" :hover="true">
      <button v-if="!route.active && !route.system" @click="archiveTrip(route._id)" class="clickable">Archive</button>
      <template #content>
        <div class="tooltip-popup">This will archive the route</div>
      </template>
    </Popper>
    <Popper :interactive="false" :hover="true">
      <button @click="removeTrip(route._id)" class="bg-red fg-white clickable">Remove</button>
      <template #content>
    ...
    <Popper :interactive="false" :hover="true" v-if="calendarDatesSet">
      <button @click="downloadCalendar(route._id)" class="bg-blue fg-white clickable">Download</button>
      <template #content>
        <div class="tooltip-popup">This will download the calendar file for this route</div>
      </template>
    </Popper>
    <button
      v-if="$store.state.adminToken != null && !route_prop.system && !$store.state.settings.hideAdminFunctions"
