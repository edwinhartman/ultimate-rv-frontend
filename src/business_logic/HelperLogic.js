...
export function determineDistanceBetweenTwoPoints(coordinate1, coordinate2) {
  return calcCrow(coordinate1.latitude, coordinate1.longitude, coordinate2.latitude, coordinate2.longitude)
}
