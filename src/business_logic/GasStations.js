          ...
          for (let j = 1; j < res.data.data[i].length; j++) {
            var calloutDelegate = {
              calloutElementForAnnotation: function (annotation) {
                ...
                switch(res.data.data[i][j].displayName){
                  case "Circle K":imageName = "circle-k-logo.png";break
                  case "QuikTrip":imageName = "quicktrip-logo.png";break
                  case "Murphy Usa":imageName = "murphy-usa-logo.png";break
                  case "Shell":imageName = "shell-logo.png";break
                  case "Chevron":imageName = "chevron-logo.png";break
                  case "Valero":imageName = "valero-logo.png";break
                  case "Exxon":imageName = "exxon-logo.png";break
                  case "Texaco":imageName = "texaco-logo.png";break
                }
                //title.textContent = annotation.title;
                if (imageName != ""){
                  title.innerHTML = "<img class='w-4 inline pr-2' src='/static/" + imageName + "' /><div class='ml-1 inline'>" +
            ...
            const marker = {
              ...
              contents:
                  ...
                  res.data.data[i][j].diesDate +
                  "</td></tr>" +
                  "</table>Distance: " + res.data.data[i][j].distance + " miles",
